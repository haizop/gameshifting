...
class Game extends React.Component {
  ...
  toggleDynamic(dynamicId) {
    // const newPanelGroups = $.map(this.state.board.panelGroups, (panelGroup) => {
    //   $.map(panelGroup.panels, (panel) => {
    //     $.map(panel.dynamics, (dynamic) => {
    ...
    // newBoard.panelGroups = $.extend({}, newPanelGroups);
    //
  ...
  //   gameState.board.panelGroups = $.map.gameState.board.panelGroups
  //   $.each(gameState.board.panelGroups, (panelGroup) => {
  //     panelGroup = $.map(panelGroup)
  //   })
  // }
  ...
  setTestStateObj() {
    ...
    // const newState = this.parseGameStateRe(testState);
